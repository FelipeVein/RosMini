...
class message_class:
    ...
    start_bytes_read_topics = 'rmtopic!'
            ...
            if data.decode() == message_class.start_bytes.decode():
                ...
                if data:
                    ...
                    if data:
                        ...
                        self.sock.sendto(bytes(str(len_message)).ljust(4, b' '), addr)
                ...
                len_message = len(message)
                self.sock.sendto(bytes(len_message), addr)
                self.sock.sendto(bytes(message), addr)
